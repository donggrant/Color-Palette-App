    ...
    <View style={styles.container}>
      ...
      <View style = {styles.bottom}>
        <TouchableOpacity onPress={() => setCountRed(countRed + 1)}>
          <Text style = {{backgroundColor: '#fd0060', color: 'white', fontSize: 25, padding: 10, margin: 5, borderWidth: 5, fontFamily: "Cochin", borderRadius: 20, overflow: 'hidden'}}>                 </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setCountOrange(countOrange + 1)}>
          <Text style = {{backgroundColor: '#fd0004', color: 'white', fontSize: 25, padding: 10, margin: 5, borderWidth: 5, fontFamily: "Cochin", borderRadius: 20, overflow: 'hidden'}}>                 </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setCountYellow(countYellow + 1)}>
          <Text style = {{backgroundColor: '#ff5800', color: 'white', fontSize: 25, padding: 10, margin: 5, borderWidth: 5, fontFamily: "Cochin", borderRadius: 20, overflow: 'hidden'}}>                 </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setCountLime(countLime + 1)}>
          <Text style = {{backgroundColor: '#ff9300', color: 'white', fontSize: 25, padding: 10, margin: 5, borderWidth: 5, fontFamily: "Cochin", borderRadius: 20, overflow: 'hidden'}}>                 </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setCountGreen(countGreen + 1)}>
          <Text style = {{backgroundColor: '#ffc900', color: 'white', fontSize: 25, padding: 10, margin: 5, borderWidth: 5, fontFamily: "Cochin", borderRadius: 20, overflow: 'hidden'}}>                 </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setCountCyan(countCyan + 1)}>
          <Text style = {{backgroundColor: '#fff300', color: 'white', fontSize: 25, padding: 10, margin: 5, borderWidth: 5, fontFamily: "Cochin", borderRadius: 20, overflow: 'hidden'}}>                 </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setCountBlue(countBlue + 1)}>
          <Text style = {{backgroundColor: '#93ff00', color: 'white', fontSize: 25, padding: 10, margin: 5, borderWidth: 5, fontFamily: "Cochin", borderRadius: 20, overflow: 'hidden'}}>                 </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setCountPurple(countPurple + 1)}>
          <Text style = {{backgroundColor: '#28ff08', color: 'white', fontSize: 25, padding: 10, margin: 5, borderWidth: 5, fontFamily: "Cochin", borderRadius: 20, overflow: 'hidden'}}>                 </Text>
        </TouchableOpacity>
